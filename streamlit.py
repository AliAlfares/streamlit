...
st.write("حاد على الشقة الي يبونها ويتفقون انهم يختارو شقة أقل شي فيها ثلاث غرف وثلاث حمامات وتكون مؤثثة ومساحتها  ")
st.write("لاتقل عن 200 متر ")

st.write("ابو حمود: تمام تمام الي تبونه عندي تفضلو")
st.image("final.png")

st.write(" فايز: لا يخوي خبال هو أرخص شي ب مليون ونص لاقينا باللفة انت دام كذا شوف لنا شقة بغرفة وحدة إلين يسهلها ربك")
st.write("مؤيد: تستهبل أنت.. أنا أحين دوبني طايقك تبيني أنام معك بغرفة وحدة دام الدعوة كذا سلام عليكم انا معود خليص")
st.write("هلال : أقول خذني معك دام السالفة كذا")
st.write(" بالنهاية .. فايز يستسلم ويقول ياشيخ أبو اليوم الي عرفتكم فيه يلا مشينا نعود الديرة. ورجعوا خايبين ويابوزيد كأنك ما غزيت ")
st.image("ff.jpg")
